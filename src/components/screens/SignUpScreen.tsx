    ...
    <div className="h-full flex flex-col justify-between bg-stone-50 text-stone-900 p-6 select-none overflow-y-auto">
      <div>
        ...
        <div className="flex items-center gap-3 pt-1 mb-6">
          ...
          <h1 className="text-base font-bold text-stone-900">Create Account</h1>
        </div>

        {/* Title */}
        <div className="mb-6">
          <h2 className="text-2xl font-black text-stone-900 tracking-tight">
            Join the neighborhood skill bank
          </h2>
          <p className="text-xs text-stone-600 mt-1.5 leading-relaxed">
            Exchange skills directly, build community connections, and earn your first free time credit.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <label className="flex items-start gap-2 pt-1 cursor-pointer">
            ...
            <span className="text-[11px] text-stone-600 leading-tight">
              I agree to the Community Trust & Mutual Respect Guidelines and Time-Banking Charter.
            </span>
          </label>
          ...
          <button
            type="submit"
            disabled={!agreeTerms}
            className="w-full mt-4 py-3.5 rounded-2xl bg-emerald-800 hover:bg-emerald-900 text-white font-semibold text-xs tracking-wide shadow-md shadow-emerald-900/20 active:scale-[0.98] transition-all disabled:opacity-50"
          >
